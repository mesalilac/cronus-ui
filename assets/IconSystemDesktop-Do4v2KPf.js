...
\`\`\`
   ...
   ░▒▓▓▓▓▓▓▓▓▓▓▓▓▓▓▒░
        ▒▓▓▓▓▓▓▒
        ░▒▒▒▒▒▒░
\`\`\``,displayName:`IconSystemDesktop`,filePath:`C:/Users/bmjfd/Documents/Dev/cronus-ui/src/icons/System/IconSystemDesktop.tsx`,methods:[],props:{size:{defaultValue:null,declarations:[{fileName:`cronus-ui/src/icons/System/IconSystemDesktop.tsx`,name:`IconProps`}],description:``,name:`size`,parent:{fileName:`cronus-ui/src/icons/System/IconSystemDesktop.tsx`,name:`IconProps`},required:!1,tags:{},type:{name:`string | undefined`}}},tags:{}}}catch{}}));export{l as n,c as t};