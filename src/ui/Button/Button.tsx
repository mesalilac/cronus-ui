...
export const Button = <T extends ValidComponent = 'button'>(
    ...
    const buttonAppearanceStyle: ButtonStyle = {
        primary: {
            ...
            ghost: cn('text-accent hover:bg-accent/30'),
        ...
        secondary: {
            ...
            ghost: cn('hover:bg-surface-3/30'),
        ...
        info: {
            ...
            ghost: cn('text-info hover:bg-info/30'),
        ...
        success: {
            ...
            ghost: cn('text-success hover:bg-success/30'),
        ...
        warning: {
            ...
            ghost: cn('text-warning hover:bg-warning/30'),
        ...
        danger: {
            ...
            ghost: cn('text-danger hover:bg-danger/30'),
