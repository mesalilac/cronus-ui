...
export const Button = <T extends ValidComponent = 'button'>(
    ...
    const buttonAppearanceStyle: ButtonStyle = {
        ...
        info: {
            ...
            ghost: cn('text-text-info hover:bg-info/80'),
        ...
        success: {
            ...
            ghost: cn('text-text-success hover:bg-success/80'),
        ...
        warning: {
            ...
            ghost: cn('text-text-warning hover:bg-warning/80'),
        ...
        danger: {
            ...
            ghost: cn('text-text-danger hover:bg-danger/80'),
