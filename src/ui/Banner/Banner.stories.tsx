...
export const Success: Story = {
    render: () => {
        return (
            <div>
                <Banner variant='success'>Banner Content</Banner>
                <PlaceholderText />
            </div>
        );
    },
...
export const Warning: Story = {
    render: () => {
        return (
            <div>
                <Banner variant='warning'>Banner Content</Banner>
                <PlaceholderText />
            </div>
        );
    },
...
export const Danger: Story = {
    render: () => {
        return (
            <div>
                <Banner variant='danger'>Banner Content</Banner>
                <PlaceholderText />
            </div>
        );
    },
...
export const Info: Story = {
    render: () => {
        return (
            <div>
                <Banner variant='info'>Banner Content</Banner>
                <PlaceholderText />
            </div>
        );
    },
...
export const Top: Story = {
    render: () => {
        return (
            <div>
                <Banner placement='top'>Banner Content</Banner>
                <PlaceholderText />
            </div>
        );
    },
...
export const Bottom: Story = {
    render: () => {
        return (
            <div>
                <Banner placement='bottom'>Banner Content</Banner>
                <PlaceholderText />
            </div>
        );
    },
