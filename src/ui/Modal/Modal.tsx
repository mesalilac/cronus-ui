            ...
            <Transition onEnter={onEnterAnim} onExit={onExitAnim}>
                <Show when={props.open}>
                    ...
                    >
                        <div
                            class={cn(
                                'pointer-events-auto relative flex size-9/12 flex-col gap-2 rounded-lg border border-border bg-surface-1/80 p-4 text-text-primary shadow-default backdrop-blur-sm will-change-transform',
                                props.class,
                            )}
